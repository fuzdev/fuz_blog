<script lang="ts">
	...
	import Toot from '@fuzdev/fuz_mastodon/Toot.svelte'; // TODO @many make optional
	import {mastodon_cache_context} from '@fuzdev/fuz_mastodon/mastodon_cache.svelte.js'; // TODO @many make optional
